...
model = load_model("hackaxxess2026\\backend\my_model.h5")
scaler = pickle.load(open("hackaxxess2026\\backend\scaler.pkl", "rb"))
le = pickle.load(open("hackaxxess2026\\backend\label_encoder.pkl", "rb"))
